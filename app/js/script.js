// function hello(id){
//   var description = fullProducts[id];
//   console.log('des', description);
//
//   var productTemplate = $('#productTemplate').html();
//   var productScript = Handlebars.compile(productTemplate);
//   var productContent = {grownMenu: grownProducts};
//   var productHtml = grownScript(productContent);
...
$(document).ready(function() {
  ...
  var fullModal = document.querySelectorAll('.fullModal');
  for(i = 0; i < fullModal.length; i++){
    fullModal[i].addEventListener('click', function(){
      var id = $(this).attr('id')
  ...
  var grownModal = document.querySelectorAll('.grownModal');
  for(i = 0; i < grownModal.length; i++){
    grownModal[i].addEventListener('click', function(){
      var id = $(this).attr('id')
